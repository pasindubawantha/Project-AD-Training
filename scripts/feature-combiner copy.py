...
# args
input_feature_file = "../data/lseg/lse_2009-07-24_2020-03-20-Volume.csv"
input_directory = "../results/data"
input_file_metrics = ["Price","Open","High","Low","Vol"]
output_file = "../results/all-features.csv"

# models = ["arma","arima","lstm","cnn","lstmcnn_wsum_combination","lstmcnn_wsum_layer_lstmDlayer","lstmcnn_wsum_layer"]
models = ["lstm","cnn","lstmcnn_wsum_combination","lstmcnn_wsum_layer_lstmDlayer","lstmcnn_wsum_layer"]
